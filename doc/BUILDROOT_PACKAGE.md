# Thingino Streamer Buildroot Package

This directory contains the updated buildroot package files for thingino-streamer with JSON configuration support.
...
- All existing thingino-streamer functionality remains unchanged
